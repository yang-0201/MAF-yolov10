...
class RepELANMSv2(nn.Module):
    def __init__(self, in_channels, out_channels, width = 3, depth=1, depth_expansion=2, kersize=5, shortcut=True, expansion=0.5,
        ...
        for i in range(width - 1):
            ...
            for j in range(depth):
                DepthBlock.append(DepthBottleneckUni(self.c_, self.c_, shortcut, kersize, depth_expansion, small_kersize, use_depthwise))
